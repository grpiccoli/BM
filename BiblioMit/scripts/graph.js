...
psmb.setChoices(() => __awaiter(this, void 0, void 0, function* () {
    return yield fetch('/ambiental/psmblist')
...
variables.setChoices(() => __awaiter(this, void 0, void 0, function* () {
    return yield fetch('/ambiental/variablelist')
        .then(items => items.json())
        .catch(err => console.log(err));
}));
var temp;
...
tl.setChoices(() => __awaiter(this, void 0, void 0, function* () {
    return yield fetch('/ambiental/tllist')
        .then(items => items.json())
        .catch(err => console.log(err));
}));
function Area(array) {
